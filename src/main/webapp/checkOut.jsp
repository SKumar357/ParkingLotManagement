			...
			<form method="POST" action="checkOutSubmit">
				<table class="checkOutTable">
					<tr>
						...
						<td><input type="text" id="vnumber" name="vnumber" required
							autocomplete="off" placeholder="Enter Vehicle number"></td>
					</tr>
					<tr>
						<td><label for="checkOut">Check out Time</label></td>
						<td><input type="datetime-local" id="checkOut"
							name="exittime" required></td>
					</tr>
				</table>
...
<script>
	...
	document.getElementById("checkOut").min = today + '00:00';
</script>
</html>